...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    ...
    <asp:Panel ID="formPanel" runat="server" Visible="False">
        <asp:Label ID="Label1" runat="server" Text="Id" Enabled="False"></asp:Label>
        <asp:TextBox ID="txtId" runat="server" Enabled="False"></asp:TextBox>
        <br />
        <asp:Label ID="Label2" runat="server" Text="Legajo" Enabled="False"></asp:Label>
        ...
        <br />
        <asp:Label ID="Label3" runat="server" Text="Nombre" Enabled="False"></asp:Label>
        ...
        <br />
        <asp:Label ID="Label4" runat="server" Text="Apellido" Enabled="False"></asp:Label>
        ...
        <br />
        <asp:Label ID="Label5" runat="server" Text="Email" Enabled="False"></asp:Label>
        ...
        <br />
        <asp:Label ID="Label6" runat="server" Text="Direccion" Enabled="False"></asp:Label>
        ...
        <br />
        <asp:Label ID="Label7" runat="server" Text="Telefono" Enabled="False"></asp:Label>
        <asp:TextBox ID="txtTelefono" runat="server" TextMode="Phone"></asp:TextBox>
        <br />
        <asp:Label ID="Label8" runat="server" Text="Fecha Nacimiento" Enabled="False"></asp:Label>
        ...
        <br />
        <asp:Label ID="Label9" runat="server" Text="Tipo de Persona" Enabled="False"></asp:Label>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="ddlPlan" ErrorMessage="El campo no puede estar vacío" ForeColor="Red" ValidationGroup="AllValidators"></asp:RequiredFieldValidator>
